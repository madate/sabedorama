...
$sq_valida_jogo=  mysql_query("SELECT COUNT(*) FROM perguntas WHERE jogo_idjogo=$jogo");
...
foreach($lines as $line)
{
    ...
    switch($i) {
              ...
              // $certa = trim($line);
               ...
               // $errada = trim($line);
               // echo "INSERT INTO perguntas (pergunta, certa, indiferente, errada,linha, coluna,  jogo_idjogo) VALUES ('$pergunta', '$certa', '$indiferente', '$errada',$li, $coluna, $jogo)";
                $sql = "INSERT INTO perguntas (pergunta, certa, indiferente, errada,linha, coluna,  jogo_idjogo) VALUES (\"$pergunta\", \"$certa\", \"$indiferente\", \"$errada\",$li, $coluna, $jogo)";
