					...
					$('#btn-crop').click(function(){
						$.post( 'crop.php', {
							...
							h: $('#h').val()
                                                    ...
                                                    var nome_novo=dados;
							$('#div-jcrop').html( '<img src="../img/' + nome_novo + '?' + Math.random() + '" width="'+$('#w').val()+'" height="'+$('#h').val()+'" />' );
							$('#debug').hide();
							$('#tit-jcrop').html('Imagem enviada com sucesso!<br /><a href="../index.php">Voltar para o Sabedorama</a>');
						});
						return false;
					});
				});
