...
$indi=$_POST['indi'];
$certos=$_POST['certos'];
$inserir=mysql_query("INSERT INTO jogador_jogando (jogador_idjogador, score, tempo_total, jogo_idjogo, nivel,certo, errado,indiferente,finalizado) VALUES
    ($id,$score,$tempo,$jogo,$nivel,$certos,$erros,$indi,1)");
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#cb60b3', endColorstr='#db36a4',GradientType=0 ); /* IE6-9 */
  ...
  -webkit-border-radius: 8px;
    ...
    <br>
    <div style ="margin-top: 10px"> <?php echo substr($nome,0,10);?></div>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#45484d', endColorstr='#000000',GradientType=0 ); /* IE6-9 */
 color: white;vertical-align: middle; 
        ...
        <?php $sq_nome_jogo=mysql_query("SELECT nome FROM jogo WHERE idjogo=$jogo");
...
while($rank=mysql_fetch_array($sq_jogo_jogador)){
    ...
    $sq_img=mysql_query("SELECT image FROM jogador WHERE idjogador='".$rank['jogador_idjogador']."'");
...
<td ><img src='img/$img' width='25' heigth='25'/>  $nome</td><td>$nome_jogo</td><td>$nivel</td><td>".$rank['score']."</td><td>".gmdate("G:i:s",$rank['tempo_total'])."</td></tr>";
}
echo"</table>";?>
