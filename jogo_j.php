...
<html lang="br">
 ...
 <span style="color: #e9322d ; font-size: 18px; float: right; margin-top: 8px;margin-right: 20px;font-weight: bold; text-shadow: 0.5px 0.5px 2px #CFCFCF;">
        ...
        $sq_nivel = mysql_query("SELECT $nive from jogo where idjogo=$treino");
        $tempo_de_jogo = mysql_result($sq_nivel, 0);
        $sq_pergunta = mysql_query("SELECT pergunta from perguntas where jogo_idjogo=$treino order by idperguntas ");
        $sq_certo = mysql_query("SELECT certa from perguntas where jogo_idjogo=$treino");
        $sq_errado = mysql_query("SELECT errada from perguntas where jogo_idjogo=$treino");
        $sq_indi = mysql_query("SELECT indiferente from perguntas where jogo_idjogo=$treino");
...
//echo $bot;
        ...
        ?>];var posicao= $.randomBetween(1,7);
                                ...
                                setInterval(function() {
                                    ...
                                    if(tempo2==0){
                                        ...
                                        $('#'+posicao).css("backgroundColor", "white");
                                ...
                                $(".btn").click(function(){
                                    ...
                                    if(resposta=="certo"){
                                        ...
                                        bonus=bonus+1;
                                        score2=20;
                                        $('#'+posicao).css("backgroundColor", "yellow");
                                        ...
                                        if(posicao>168){
                                            ...
                                            //$("#tea").show();
                                            $.post("fim.php",{jogo:<?php echo"$treino" ?>, nivel:<?php echo"$nivel" ?>,recorde:score,tempo:total,erros:erradas,certos:certas,indi:indife},
                                            function(retorno){
                                                $("#tre").html(retorno);
                                            }, "html");
                                            //$("#tre").load("inserir_horas.php");
                                            /*      
                            var novaURL = "fim.php?treino=1&nivel=1&score="+score+"&tempo="+total+"&erros="+erradas+"&certos="+certas+"&indi="+indi;
        $(window.document.location).attr('href',novaURL);*/
                                    ...
                                    if(resposta=="errado"){
                                        ...
                                        $('#'+posicao).css("backgroundColor", "red");
                                    ...
                                    if(resposta=="indiferente"){
                                        ...
                                        $('#'+posicao).css("backgroundColor", "#045eb5");
                                        if(posicao==1){posicao=posicao+6}
                                        else if(posicao==8){posicao=posicao+6}
                                        else if(posicao==15){posicao=posicao+6}
                                        else if(posicao==22){posicao=posicao+6}
...
<table width='100%'> <tr style='height: 10px; width:30px'>";
            $col = 0;
            $linha = 24;
            $j = 168;
            for ($i = 0; $i < 168; $i++) {
                ...
                echo"<td  style='height: 10px;background-color: #d5d0d0; box-shadow: INSET 0 0 3px #888'  id='$j'></td>";
            ...
            <div id="nav">
                <div id="img"></div>
                <div style="background-color: red; width: 200px"><img style="float: left; width: 50px;height: 67px" src="images/cron.png" /><div id="tempo" ></div></div>
                ...
                <br>
                <span id=""><button id="btn1"  class="btn btn-info" value=""></button></span>
                <span id=""><button id="btn2" class="btn btn-info" value=""></button></span>
                <span id=""><button id="btn3"  class="btn btn-info" value=""></button></span>
                <br>
                <br>
                <div id="regras">


                    <button class="btn"  id="regra" href="ajax.html" title="Regras do Sabedorama"><i class="icon-question-sign"></i>Regras do jogo</button><button  title="Novo jogo" id="novo" class="btn "><i class="icon-refresh"></i>Novo Jogo</button>
                    <a href="escolhe.php" title="Escolher outro jogo" id="novo" class="btn "><i class="icon-refresh"></i>Escolher Jogo</a></div>
            </div>
