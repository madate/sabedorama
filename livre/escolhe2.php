...
<script type="text/javascript">
  ...
  $(".nivel").click(function(){
        ...
        nivel=$(this).val();
          var novaURL = "saber.php?jogo="+jogo+"&nivel="+nivel;
...
<div id="tamanho">
<div id="box">
<?php $sq_jogo=mysql_query("SELECT * FROM jogo where iddisciplina=$id and ativo=1 and status='Free'");
while($jogo=mysql_fetch_array($sq_jogo)){
    echo"<button id='jogo' class='jogo' value='".$jogo['idjogo']."'>".$jogo['nome']."</button>";
