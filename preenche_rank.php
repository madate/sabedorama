...
echo "<tr bgcolor='$cor' align='center'><td >".$posicao."º</td><td >$nome</td><td>".round($rank['media_pontos'],2)."</td><td>".gmdate("i:s",$rank['tempo'])."</td><td>$treino[1]</td></tr>";
}
echo"</table></div>";
