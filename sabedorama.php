...
require_once 'conection.php';
 if(isset($_SESSION['sabedorama'])){
     ...
     $sq_nome=mysql_query("SELECT nome FROM jogador WHERE idjogador='".$_SESSION['sabedorama']."'");
      ...
      $bem="Bem vindo $nome <a style='margin-left:8px' class='btn btn-danger' title='Sair do sistema' href='sair.php' ><i class='icon-off'></i></a>";
...
//echo $bot;
        ...
        $(window.document.location).attr('href',novaURL);*/
                                ...
                                $("#novo").click(function(){
                                    var novaURL = "treino.php?jogo=<?php echo$treino; ?>&nivel=<?php echo$nivel; ?> ";
                                    $(window.document.location).attr('href',novaURL);
