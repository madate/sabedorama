...
echo"<option>Escolha um jogo</option>";
        while($jogo=mysql_fetch_array($sq_jogo)){
            echo"<option value='".$jogo['idjogo']."'>".$jogo['nome']."</option>";
        }
}
...
$jogo=mysql_fetch_array($sq_jogo);
echo"<tr>
                <td>Status</td>
                <td><select name='status'>
                        
                      <option>".$jogo['status']."</option>
                        <option>Free</option>
                        <option>Logado</option>
                    </select></td>
            </tr>";
echo" <tr><td>Nome: </td><td><input type='text' size='40' name='nome' id='nome' value='".$jogo['nome']."' /></td>";
echo" <tr><td>Fácil: </td><td><input type='text' size='40' name='facil' id='facil' maxlength='2' value='".$jogo['facil']."' /></td>";
echo" <tr><td>Normal: </td><td><input type='text' size='40' name='normal' id='normal' maxlength='2' value='".$jogo['normal']."' /></td>";
echo" <tr><td>Dificil: </td><td><input type='text' size='40' name='dificil' id='dificil' maxlength='2' value='".$jogo['dificil']."' /></td>";
if($jogo['ativo']==1){
